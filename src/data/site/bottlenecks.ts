...
export const BOTTLENECKS: Bottleneck[] = [
  ...
  { id: 'escolha-justa', title: 'Escolha justa', modules: 'M3 · M4',
    why: 'IA erra e pode ter preconceito escondido. Se errar, deixa de fora gente que merecia a chance.',
    progress: 'A proposta é: a IA recomenda, uma pessoa confirma. Ainda em decisão.',
    helpers: 'Pesquisa em viés de IA, ética, direitos humanos.' },
  { id: 'conversar-com-quem-nao-le', title: 'Conversar com quem não lê', modules: 'M4',
    why: 'A IA tem que entender sotaque, gíria e barulho de rua. E o aparelho precisa ser barato, aguentar o dia a dia e funcionar com internet ruim.',
