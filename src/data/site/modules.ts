...
export const MODULES: ProjectModule[] = [
  ...
  { id: 'M7', name: 'IA contínua', status: 'planned',
    ...
    what: 'Uma IA fácil, por voz, que fica com a pessoa da conversa em diante e nunca para. Antes do trabalho, ajuda a entender o que ela sabe fazer e o que ela quer.',
