...
export const MODULES: ProjectModule[] = [
  ...
  { id: 'M3', name: 'Captação de candidatos', status: 'bottleneck',
    ...
    what: 'O jeito de escolher quem entra, com ajuda da IA e à vista de todos. E os jeitos de chegar até a pessoa: voluntário na rua, panfleto, ponto público e este site.',
  ...
  { id: 'M7', name: 'IA contínua', status: 'planned',
    summary: 'Uma IA simples, por voz, que acompanha a pessoa do começo ao fim, sem prazo e de graça.',
    what: 'Uma IA fácil, por voz, que fica com a pessoa desde a escolha e nunca para. Antes do trabalho, ajuda a entender o que ela sabe fazer e o que ela quer.',
