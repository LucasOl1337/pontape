...
- `npm run check` passou após o ajuste final: 133 testes, CSP com quatro hashes e home de 29,8 KB ao abrir. O script do `<head>` preserva `?cor=` mesmo se o armazenamento falhar.
...
- Rebase feito sobre `origin/main` sem conflito antes da PR.
- PR [#64 · F28 · Paletas com seletor](https://github.com/LucasOl1337/pontape/pull/64) aberta pra `main`, com os dez prints pedidos, mais o seletor aberto, URLs `?cor=` e passos para remover/promover a paleta. Aguarda revisão do Regente.
