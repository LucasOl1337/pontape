...
- **Exemplo:** após “Ver um exemplo” e “Mudar uma linha escondido”, “Conferir” mostrou “A corrente quebrou na ação nº 2.” ([captura](ensaio/conferir-exemplo-adulterado.png)).
...
- 404 com quatro âncoras erradas: **issue a inserir** (`codigo`, `M1`).
- “Ver a fonte” do exemplo com commit de zeros: **issue a inserir** (`codigo`, `M1`).
- A+ com 8 px de rolagem horizontal em 320 px: **issue a inserir** (`design`, `M1`); relacionada à revisão de teclado e texto ampliado #8.
