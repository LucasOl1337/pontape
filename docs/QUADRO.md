...
| F03 | [Pesquisa: dinheiro, jurídico e nome](frentes/F03-pesquisa-dinheiro-juridico-nome/BRIEF.md) | bruto | `bruto/f03-pesquisa` | despachada | Três relatórios em `docs/pesquisa/` |
| F04 | [Pesquisa: entrevista por voz e dispositivo](frentes/F04-pesquisa-voz-dispositivo/BRIEF.md) | devin (via fino) | `devin/f04-voz` | despachada | Relatório em `docs/pesquisa/` |
...
| F06 | Rede de oportunidades: redes de emprego existentes, como empregador oferece vaga | F03 |
...
4. Doação antes de existir CNPJ
5. Cidade do piloto
