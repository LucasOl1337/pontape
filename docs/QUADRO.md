...
|---|---|---|---|---|---|
| F43 | [Contador público, painel do admin e histórico da Yume](frentes/F43-metricas-admin/BRIEF.md) | tecla | `tecla/f43-metricas` | Em andamento (D042): D1 criado, secrets no Worker | Proposta do lugar do contador; PR pro Regente |
