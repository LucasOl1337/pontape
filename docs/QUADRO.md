...
Atualizado: 24/09/2026, tarde · Site sem crédito pessoal (D036), contador de visitas (D037), **sem Bitcoin** (D038), transparência com corrente animada e selo novo (F42 E1, PRs #100 a #103), **Lastro (Grok 4.7) no E2**, transparência em uma tela (#104), **Yumi no ar (F41, D039)** · **Divulgação começou** (D035): `/perguntas` com quem faz e contato (PR #97), posts no X e no LinkedIn do Lucas publicados pelo Regente · Home em tom de marca (D034, PR #96) e lema caridade inteligente (D033) · **Lema novo: caridade inteligente** (D033, PR #91) · **Site no ar em https://pontape.org** (D019), publicação automática ligada (D021)
